...
//CODE HERE
class  Ticket {
    constructor (items, orderTimes, customerId){
        this.items = items;
    ...
    updatedStatus(newStatus){
        this.staus = newStatus

        console.log(`${this.customerId} is now ${this.staus}` )
    }
...
//CODE HERE
let firstTicket = new Ticket (["Pizza","Soda","bread"], "7:03pm", 575,)
